...
local Camera = Workspace:FindFirstChild("CurrentCamera") or game.Workspace.CurrentCamera
...
local CGlobals, BlockInfo, ItemInfo, ItemLevels, BlockHighlights
...
local function safeRequire(module, moduleName)
	...
	if not success then
		local Notify = AkaliNotif.Notify;
		Notify({
			Description = "Your executor doesn't support require for " .. moduleName;
			Title = "Warning!";
			Duration = 3;
		});
		return nil
...
CGlobals = safeRequire(MainScript:WaitForChild("CGlobals"), "CGlobals")
BlockInfo = safeRequire(ReplicatedStorage:WaitForChild("AssetsMod"):WaitForChild("BlockInfo"), "BlockInfo")
ItemInfo = safeRequire(ReplicatedStorage:WaitForChild("AssetsMod"):WaitForChild("ItemInfo"), "ItemInfo")
ItemLevels = safeRequire(ReplicatedStorage:WaitForChild("AssetsMod"):WaitForChild("ItemLevels"), "ItemLevels")
BlockHighlights = safeRequire(MainScript:WaitForChild("BlockHighlights"), "BlockHighlights")
...
local ESP = pcall(function() return loadstring(game:HttpGet("https://kiriot22.com/releases/ESP.lua"))() end)
...
if not gameremotes then gameremotes = Workspace:FindFirstChild("GameRemotes") end

local GameRemotes = gameremotes
local Demo = gameremotes and (gameremotes:FindFirstChild("Demo") or Workspace:FindFirstChild("Demo"))
local abb = gameremotes and gameremotes:FindFirstChild("AcceptBreakBlock")
local bb = gameremotes and gameremotes:FindFirstChild("BreakBlock")
local Attack = gameremotes and gameremotes:WaitForChild("Attack")
local moveitems = gameremotes and (gameremotes:FindFirstChild("MoveItem") or gameremotes:FindFirstChild("MoveItems"))
local MoveItem = ReplicatedStorage:FindFirstChild("GameRemotes") and ReplicatedStorage:FindFirstChild("GameRemotes"):WaitForChild("MoveItem")
local sortitems = gameremotes and (gameremotes:FindFirstChild("SortItem") or gameremotes:FindFirstChild("SortItems"))
local useblock = gameremotes and gameremotes:FindFirstChild("UseBlock")

--[[ Adonis Bypass no xeno you suck
pcall(function()
...
function chestdupe(mode)
    if not sortitems then return end
    if mode == 1 then
        pcall(function()
...
function TriggerBot()
    ...
    if currentTarget and Attack then
        ...
        if hum and hum.Health > 0 and tHRP then
            ...
            if (d.X*d.X + d.Z*d.Z) <= (_G.RANGE_SQ or 400) then
                pcall(function()
...
local function autoEquipArmor()
	...
	if not inv or not MoveItem then return end
...
local function getItemSpeed(itemName, reqType, betterTool)
	if not ItemInfo or not ItemLevels then return 1 end
...
local function getBestToolSlot(blockName)
	if not BlockInfo or not Inventory then return nil end
...
--===MODULES===--
local EssentialsModule, KillAura, TargetStrafe, Hitbox, CombatLog, AutoSafeZone, NoFall, Sprint, AutoEat, Jesus, InfiniteHealth, CrosshairPlus, RainbowCrosshair, Fullbright, XRay, ChestESP, LavaESP, PlayerESP

pcall(function()
	EssentialsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/Essentials.lua"))()
end)
pcall(function()
	KillAura = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/kill-aura.lua"))()
end)
pcall(function()
	TargetStrafe = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/target-strafe.lua"))()
end)
pcall(function()
	Hitbox = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/hitbox-expander.lua"))()
end)
pcall(function()
	CombatLog = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/auto-combat-log.lua"))()
end)
pcall(function()
	AutoSafeZone = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/auto-safe-zone.lua"))()
end)
pcall(function()
	NoFall = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/no-fall.lua"))()
end)
pcall(function()
	Sprint = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/sprint.lua"))()
end)
pcall(function()
	AutoEat = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/auto-eat.lua"))()
end)
pcall(function()
	Jesus = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/jesus.lua"))()
end)
pcall(function()
	InfiniteHealth = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/infinite-health.lua"))()
end)
pcall(function()
	CrosshairPlus = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/crosshair-plus.lua"))()
end)
pcall(function()
	RainbowCrosshair = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/rainbow-crosshair.lua"))()
end)
pcall(function()
	Fullbright = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/fullbright.lua"))()
end)
pcall(function()
	XRay = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/xray.lua"))()
end)
pcall(function()
	ChestESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/chest-esp.lua"))()
end)
pcall(function()
	LavaESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/lava-esp.lua"))()
end)
pcall(function()
	PlayerESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/screengui/bytehub/refs/heads/main/Byte%20Hub/minerscave/modules/player-esp.lua"))()
end)
  
local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
local InterfaceManager = pcall(function() return loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua"))() end)
...
Tabs.lp:AddButton({
    ...
    Callback = function()
        pcall(function()
            game.ReplicatedStorage:WaitForChild("GameRemotes"):WaitForChild("MoveItem"):InvokeServer(101, 9, true)
        end)
    end
})
...
if CGlobals and BlockHighlights then
...
local nktog = Tabs.wr:AddToggle("Nuker", {
    ...
    Callback = function(n)
        ...
        local function nukerLoop()
            while nk do
                if not bb or not abb then return end
                pcall(function()
